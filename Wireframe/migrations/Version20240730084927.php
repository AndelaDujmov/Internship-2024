 ...
 */
final class Version20240730084927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annual_leave (id VARCHAR(36) NOT NULL, worker_id INT NOT NULL, year INT NOT NULL, total_days INT NOT NULL, month VARCHAR(20) NOT NULL, INDEX IDX_4F87A2346B20BA36 (worker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE request_for_al (id VARCHAR(36) NOT NULL, worker_id INT NOT NULL, team_leader_id INT DEFAULT NULL, project_leader_id INT DEFAULT NULL, start DATE NOT NULL, end DATE NOT NULL, reason VARCHAR(255) DEFAULT NULL, date_of_processing DATE NOT NULL, INDEX IDX_A160188C6B20BA36 (worker_id), INDEX IDX_A160188CC4105033 (team_leader_id), INDEX IDX_A160188C62290B03 (project_leader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE team_leaders (id VARCHAR(36) NOT NULL, team_id VARCHAR(36) NOT NULL, project_leader_id INT NOT NULL, team_lead_id INT NOT NULL, INDEX IDX_FC351AA1296CD8AE (team_id), INDEX IDX_FC351AA162290B03 (project_leader_id), INDEX IDX_FC351AA1FF2C34BA (team_lead_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, team_id VARCHAR(36) DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_8D93D649296CD8AE (team_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
