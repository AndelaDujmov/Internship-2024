 ...
 */
final class Version20240729105125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role (id VARCHAR(36) NOT NULL, name VARCHAR(40) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id VARCHAR(36) NOT NULL, role_id VARCHAR(36) NOT NULL, team_id VARCHAR(36) DEFAULT NULL, name VARCHAR(30) NOT NULL, surname VARCHAR(50) NOT NULL, INDEX IDX_8D93D649D60322AC (role_id), INDEX IDX_8D93D649296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
